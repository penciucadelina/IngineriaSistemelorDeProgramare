...
public class AquariumControllerTest {
    ...
    public void testSetCurrentTime() {
        AquariumController controller = new AquariumController("Test Manufacturer", "Test Model", 0.0f, 0.0f, new FishFeeder("Test Feeder Manufacturer", "Test Feeder Model"));
    ...
    public void testToString() {
        ...
        AquariumController controller = new AquariumController("Test Manufacturer", "Test Model", 0.0f, 0.0f, feeder);
